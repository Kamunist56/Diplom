...
var
  newName: String;
begin
  if InputQuery('Добавление новой должности', 'Введите наименование', newName)
  then
  begin
...
begin
  ...
  Pos.name := InputBox('Редактирование должности',
    'Введите новое наименование должности', dm.QposBrowsename.AsString);
  Pos.ChangeAtr;
  dm.RefTable(dm.QposBrowse);
end;
...
begin
  if MessageBox(handle, 'Удалить дожность', 'Удаление записи',
